...
%     F1 = 2 * P * R / (P + R);
    ...
    predictedPositives = sum(predictions == 1);
    actualPositives = sum(yval == 1);
    truePositives = zeros(size(yval));
    ...
    truePredictedPositives = sum(truePositives);
    
    P = truePredictedPositives / predictedPositives;
    R = truePredictedPositives / actualPositives;
    F1 = 2 * P * R / (P + R);
